...
const GALLERY_META = [
  { caption: '무릎 꿇고 들어 올린 베일, 그게 사랑이었어요 👰 #베일리프팅', alt: '잔디밭에서 신랑이 무릎을 꿇고 신부의 레이스 베일을 들어 올리는 사진' },
  { caption: '큰 나무 아래, 처음 만난 날처럼 🌳 #풀밭위에서', alt: '나무 아래 잔디밭에 앉아 서로를 바라보는 신랑 신부' },
  { caption: '바람에 날리는 베일, 그 순간이 영화 같아요 🌬️ #야외촬영', alt: '석조 건물 아래에서 신부가 걷고 신랑이 뒤에서 베일을 들어 주는 흑백 사진' },
  { caption: '베일 안에서만 나눈, 우리만의 키스 🤍 #베일키스', alt: '레이스 베일 안에서 이마를 맞대고 키스하는 신랑 신부' },
  { caption: '나란히 서면, 모든 순간이 완벽해요 🤍 #우빈여울 #웨딩촬영', alt: '아치형 나무 문 앞에서 손을 잡고 서 있는 신랑 신부' },
  { caption: '약지에 새겨진, 우리만의 약속 💍 #결혼반지', alt: '신부가 반지 낀 손으로 신랑의 입을 가리며 키스하는 사진' },
  { caption: '창가에 앉아 나눈 조용한 이야기 🪟 #웨딩스냅', alt: '흰 창가 벤치에 나란히 앉은 신랑 신부' },
  { caption: '하얀 카라 부케에 기대어, 같은 마음을 나눠요 🌿 #부케', alt: '하얀 카라 부케를 사이에 두고 이마를 맞댄 신랑 신부' },
  { caption: '코끝에 묻은 케이크, 웃음이 먼저예요 🎂 #케이크피딩', alt: '검은 옷을 입고 앉아 핑크 장미 케이크로 장난치는 커플' },
  { caption: '계단 위에서 나눈 포근한 포옹 🤍 #우리의순간', alt: '계단에서 신부가 신랑을 뒤에서 안고 함께 윙크하는 사진' },
  { caption: '바닥에 앉아도 우리만의 무대예요 🖤 #자연스러운웃음', alt: '흰 벽과 세로 창 앞에 앉아 웃고 있는 검은 옷 커플' },
  { caption: '케이크 한 입, 웃음 한 바가지 🎂 #케이크피딩', alt: '코에 생크림을 묻히고 장미 케이크를 들고 웃는 커플' },
];
  ...
  try {
    Kakao.Share.sendDefault({
      ...
      content: {
        ...
        imageUrl: siteBase() + '/images/teaser_hero.jpg',
